...
void	ft_draw_player_minimap(t_game *game)
{
	...
	int offset = 3;
	ft_draw_line(game->img, ft_init_vector(p->pos->y * size + offset, p->pos->x * size + offset), ft_init_vector(p->pos->y * size + p->dir->y * p->walk_speed * 200 + offset, p->pos->x * size + p->dir->x * p->walk_speed * 200 + offset));
